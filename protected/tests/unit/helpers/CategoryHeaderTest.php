...
class CategoryHeaderTest extends PHPUnit_Framework_TestCase
{
	public function parseDataProvider()
	{
		return array(
			...
			array('dog', array('' => array(array('term' => 'dog')))),
			array(
				'dog; label="Canine"; scheme="http://purl.org/net/animals"',
				array(
					'http://purl.org/net/animals' => array(
						array('term' => 'dog', 'label' => 'Canine'),
					),
				),
			),
			array(
				...
				array(
					...
					'http://purl.org/net/animals/dogs' => array(
						array(
							'term' => 'lowchen',
							// enc2231 support not implemented so the label is ignored
						),
					),
				),
			),
